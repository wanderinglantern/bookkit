...
def create_app(db_path: Path | str | None = None) -> FastAPI:
    ...
    from .routes import account, book, capture, changes, pipeline, program, relationship, work
    ...
    # capture.router owns /capture and /capture/task — no overlap with
    # /accounts/..., so its position is free.
